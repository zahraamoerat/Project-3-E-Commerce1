...
async function loadDeliveries() {
  try {
    ...
    const response = await fetch(`/api/deliveries?buyerId=${encodeURIComponent(buyerId)}`)
...
/* Full-bleed hero content wrapper (keeps the navbar flush at the very top,
   edge-to-edge, while the sections below keep comfortable insets). */
...
.connect-sb-deliveries-card.selected {
  ...
  box-shadow:
    0 0 0 2px rgba(164, 117, 71, 0.11),
...
.connect-sb-deliveries-track-button {
  ...
  font-weight: 800;
  cursor: pointer;
  box-shadow: 0 4px 10px rgba(164, 117, 71, 0.14);
  transition:
    transform 180ms ease,
...
.connect-sb-deliveries-track-button:hover {
  ...
  background: #a37547;
  box-shadow: 0 6px 14px rgba(164, 117, 71, 0.22);
}
...
.connect-sb-deliveries-page { --sb-brown: #5c3d24; --sb-brown-dark: #4e342e; --sb-brown-soft: #eadfd5; --sb-accent: #c48b5b; }
.connect-sb-deliveries-page h1, .connect-sb-deliveries-page h2, .connect-sb-deliveries-page h3 { font-family: var(--sb-font-heading); color: var(--sb-ink); }
.connect-sb-deliveries-page .connect-sb-deliveries-overview-card,
.connect-sb-deliveries-page .connect-sb-deliveries-card { border-color: var(--sb-border); }
.connect-sb-deliveries-page .connect-sb-deliveries-overview-main,
.connect-sb-deliveries-page .connect-sb-deliveries-track-button.active { background: var(--sb-brown); color: #fff; }
.connect-sb-deliveries-page .connect-sb-deliveries-overview-icon,
.connect-sb-deliveries-page .connect-sb-deliveries-route-marker { color: var(--sb-brown); background: var(--sb-brown-soft); }
.connect-sb-deliveries-page .connect-sb-deliveries-track-button { background: var(--sb-accent); border-color: var(--sb-accent); color: #fff; }
