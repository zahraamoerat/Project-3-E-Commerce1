...
.connect-sb-orders-search:focus-within {
  ...
  box-shadow: 0 5px 18px rgba(164, 117, 71, 0.10);
}
...
.connect-sb-orders-selected-label span {
  ...
  border-radius: 50%;
  background: var(--sb-accent);
  box-shadow: 0 0 0 3px rgba(164, 117, 71, 0.10);
}
...
.connect-sb-orders-pay-button {
  ...
  background: var(--sb-accent);
  color: #FFFEFC;
  box-shadow: 0 3px 9px rgba(164, 117, 71, 0.18);
}

.connect-sb-orders-pay-button:hover {
  transform: translateY(-1px);
  background: #a37547;
  box-shadow: 0 5px 12px rgba(164, 117, 71, 0.24);
}
...
.connect-sb-orders-details-card {
  ...
  margin-top: 25px;
  padding: 25px;
  border: 1px solid rgba(164, 117, 71, 0.24);
  border-radius: 18px;
  background: #FFFEFC;
...
.connect-sb-orders-details-connector span {
  ...
  border-radius: 999px;
  background: var(--sb-accent);
  box-shadow: 0 2px 7px rgba(164, 117, 71, 0.18);
}
...
.connect-sb-orders-details-pay-button {
  background: var(--sb-accent);
  color: #FFFEFC;
  box-shadow: 0 5px 14px rgba(164, 117, 71, 0.18);
}

.connect-sb-orders-details-pay-button:hover {
  transform: translateY(-2px);
  background: #a37547;
  box-shadow: 0 7px 17px rgba(164, 117, 71, 0.25);
}
