...
.small-business-home{min-height:100vh;background:#fbf7f2;color:#493526}
...
.hero-copy{max-width:620px}.eyebrow{display:inline-block;letter-spacing:2px;font-size:11px;font-weight:800;color:#8a5a3b;margin-bottom:14px}.hero h1{font:600 clamp(42px,5vw,76px)/1.02 Georgia,serif;margin:0;color:#4a3022}.hero h1 em{color:#9b6847;font-style:italic}.hero p{font-size:17px;line-height:1.7;color:#77665a;max-width:560px;margin:24px 0}.hero-actions{display:flex;gap:12px;flex-wrap:wrap}.primary-btn,.ghost-btn,.light-btn,.text-btn{border:0;cursor:pointer;font-weight:800}.primary-btn{background:#5d3b28;color:#fff;padding:14px 22px;border-radius:999px}.ghost-btn{background:transparent;border:1px solid #cdb6a5;padding:13px 21px;border-radius:999px;color:#684832}.hero-visual{height:500px;position:relative;overflow:hidden;border-radius:28px;box-shadow:0 25px 60px #68483224}.hero-visual>img{width:100%;height:100%;object-fit:cover}.slide-card{position:absolute;left:24px;bottom:24px;max-width:350px;padding:18px 20px;border-radius:18px;background:#fffdf9e8;backdrop-filter:blur(10px)}.slide-card span{font-size:9px;font-weight:800;letter-spacing:1.5px;color:#9b6847}.slide-card strong{display:block;font:600 25px Georgia,serif;margin:5px 0;color:#4a3022}.slide-card p{font-size:12px;line-height:1.5;margin:0;color:#76665b}.slide-arrow{position:absolute;top:50%;border:0;width:40px;height:40px;border-radius:50%;background:#fff;color:#5d3b28;font-size:28px;cursor:pointer}.slide-arrow.prev{left:18px}.slide-arrow.next{right:18px}.dots{position:absolute;right:24px;bottom:25px;display:flex;gap:6px}.dots button{width:8px;height:8px;border:0;border-radius:50%;background:#fff8}.dots button.active{background:#fff;width:22px;border-radius:10px}
.section{padding:90px max(6vw,28px)}.section-heading{display:flex;justify-content:space-between;align-items:end;gap:20px;margin-bottom:30px}.section-heading h2,.feature-copy h2,.promo-strip h2{font:600 clamp(32px,4vw,48px) Georgia,serif;margin:0;color:#493225}.text-btn{background:none;color:#865637}.category-grid{display:grid;grid-template-columns:repeat(4,1fr);gap:18px}.category-card{position:relative;height:300px;padding:0;border:0;overflow:hidden;border-radius:18px;cursor:pointer;background:#ddd}.category-card img{width:100%;height:100%;object-fit:cover;transition:transform .4s}.category-card:hover img{transform:scale(1.06)}.category-overlay{position:absolute;inset:auto 0 0;padding:60px 20px 20px;text-align:left;color:#fff;background:linear-gradient(transparent,#38271fcc)}.category-overlay strong{display:block;font:600 25px Georgia,serif}.category-overlay small{opacity:.85}
.promo-strip{margin:0 max(6vw,28px) 20px;padding:42px 48px;border-radius:24px;background:#6a4530;color:#fff;display:flex;justify-content:space-between;align-items:center;gap:30px}.promo-strip h2{color:#fff;max-width:700px}.promo-strip p{color:#eaded4}.light-btn{background:#f7eadf;color:#5d3b28;padding:14px 22px;border-radius:999px;white-space:nowrap}
.products-section{background:#fffaf5}.product-grid{display:grid;grid-template-columns:repeat(4,1fr);gap:20px}.product-card{background:#fff;border:1px solid #eee1d7;border-radius:18px;overflow:hidden;cursor:pointer;transition:transform .2s,box-shadow .2s}.product-card:hover{transform:translateY(-5px);box-shadow:0 16px 35px #68483214}.product-image{height:250px;position:relative;background:#f2e8df}.product-image img{width:100%;height:100%;object-fit:cover}.badge{position:absolute;top:12px;left:12px;padding:7px 10px;border-radius:999px;background:#fff;color:#7a4e33;font-size:10px;font-weight:800}.product-info{padding:18px}.product-info>span{font-size:10px;text-transform:uppercase;letter-spacing:1px;color:#a47b60}.product-info h3{font:600 20px Georgia,serif;margin:7px 0;color:#493225}.product-info strong{display:block;font-size:18px;color:#5d3b28}.product-info small{display:block;margin-top:7px;color:#8a7465}.skeleton{height:350px;border-radius:18px;background:linear-gradient(90deg,#eee3da,#f9f1eb,#eee3da);animation:pulse 1.5s infinite}@keyframes pulse{50%{opacity:.6}}.empty{padding:60px;text-align:center;color:#8b7768}
.feature-section{display:grid;grid-template-columns:1fr 1fr;min-height:620px}.feature-image img{width:100%;height:100%;min-height:500px;object-fit:cover}.feature-copy{padding:80px max(6vw,40px);background:#f1e4d8}.feature-list{margin:35px 0}.feature-list>div{display:flex;gap:18px;padding:18px 0;border-bottom:1px solid #d8c4b2}.feature-list b{font-size:12px;color:#a16b49}.feature-list p{margin:0}.feature-list strong,.feature-list span{display:block}.feature-list span{color:#7d6b5d;margin-top:5px;line-height:1.5}.trust-row{display:grid;grid-template-columns:repeat(3,1fr);padding:38px max(6vw,28px);gap:20px;background:#493225;color:#fff}.trust-row div{padding:8px 20px;border-right:1px solid #ffffff26}.trust-row div:last-child{border:0}.trust-row strong,.trust-row span{display:block}.trust-row span{color:#d9c8bb;font-size:12px;margin-top:5px}
