...
const routes = [
  {
    ...
    children: [
      ...
      { path: "products", name: "S_Products", component: SupplierProducts },
      { path: "products/edit/:id", name: "EditProduct", component: EditProduct },
      { path: "products/view/:id", name: "ViewProduct", component: ViewProduct },
      { path: "reviews", name: "Reviews", component: Reviews },
      { path: "stockmanagement", name: "StockManagement", component: StockManagement },
      { path: "stockmanagement/restock/:id", name: "RestockPage", component: RestockPage },
      { path: "orders", name: "Orders", component: SupplierOrders },
      { path: "deliveries", name: "Deliveries", component: SupplierDeliveries },
