...
export async function updateProduct(id,data){
  ...
  try{
    ...
    await c.execute("UPDATE inventory SET quantity=?,low_stock_threshold=? WHERE product_id=?",[data.quantity??0,data.low_stock_threshold??10,id]);
